...
public class MemberAuthServiceImpl implements MemberAuthService {
    ...
    public AppAuthLoginRespVO socialLogin(AppAuthSocialLoginReqVO reqVO) {
        ...
        Long userId = socialUserApi.getBindUserId(UserTypeEnum.MEMBER.getValue(), reqVO.getType(),
                reqVO.getCode(), reqVO.getState()).getData();
        if (userId == null) {
    ...
    public AppAuthLoginRespVO weixinMiniAppLogin(AppAuthWeixinMiniAppLoginReqVO reqVO) {
        ...
        try {
            phoneNumberInfo = wxMaService.getUserService().getPhoneNoInfo(reqVO.getPhoneCode(),reqVO.getLoginCode(),reqVO.toString());
    ...
    private AppAuthLoginRespVO createTokenAfterLoginSuccess(MemberUserDO user, String mobile, LoginLogTypeEnum logType) {
        ...
        OAuth2AccessTokenRespDTO accessTokenRespDTO = oauth2TokenApi.createAccessToken(new OAuth2AccessTokenCreateReqDTO()
                ...
                .setClientId(OAuth2ClientConstants.CLIENT_ID_DEFAULT)).getData();
        // 构建返回结果
    ...
    public String getSocialAuthorizeUrl(Integer type, String redirectUri) {
        return socialUserApi.getAuthorizeUrl(type, redirectUri).getData();
    }
    ...
    public AppAuthLoginRespVO refreshToken(String refreshToken) {
        OAuth2AccessTokenRespDTO accessTokenDO = oauth2TokenApi.refreshAccessToken(refreshToken, OAuth2ClientConstants.CLIENT_ID_DEFAULT).getData();
